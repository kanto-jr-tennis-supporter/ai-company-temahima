...
/**
 * 本文中の記号で囲まれた部分を装飾する。
 * ・****文章****（アスタリスク4つ）→ オレンジ・太字・大きめ（色もサイズも変えて強調したいとき）
 * ・***文章***（アスタリスク3つ）  → オレンジ・太字（色だけ変えたいとき。文字サイズは本文と同じ）
 * ・**文章**（アスタリスク2つ）    → 赤字・太字・大きめ（色もサイズも変えて強調したいとき）
 * ・*文章*（アスタリスク1つ）      → 色はそのまま・太字・大きめ（サイズだけ大きくしたいとき）
 * 例：****先着5社様限定****のご案内です。（オレンジ・大きめ両方）
 *     ***先着5社様限定***のご案内です。（オレンジ・サイズは変えない）
 *     本日はお時間いただきありがとうございました。**先着5社様限定**のご案内です。（赤字・大きめ）
 *     *来月から新プランを開始します*（色そのまま・大きめ）
