 ...
 * ・メルマガ用シートA2の本文で、もし {{代表者名}} の後ろに手入力で「様」と書いていた場合は、
 *   その「様」の文字を削除して {{代表者名}} だけにしてください（自動で「様」＋「ご担当者様」が付くため）
 *
 * 再アプローチリスト：
 * C列：商号
 * D列：代表者名
 ...
 * ※ メルマガ用シートA2の本文側で {{代表者名}} の後ろに手入力で「様」を書いていると、
 *   ここで自動付与する「様」と二重になるので、手入力の「様」は削除しておくこと。
 */
